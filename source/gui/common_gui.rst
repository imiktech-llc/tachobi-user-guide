...
Элементы управления в представлении "Таблица"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#. **Действие** - Открытие списка операций, которые могут быть выполнены над выделенными записями. Состав списка определяется правами доступа.
#. **Экспорт** - Экспорт данных из выбранных записей в файл формата CSV или MS Excel.
...
Элементы управления в представлении "Форма"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

На рисунке ниже приведен скриншот с общими элементами управления, используемыми в представлении "Форма".
...
#. **Действие** - Открытие списка операций, которые могут быть выполнены над выделенными записями. Состав списка определяется правами доступа.
#. **Удалить** - Удаление текущего объекта учета. В случае ограничения прав доступа, данный элемент управления не доступен.
...
Элементы управления в представлении "Календарь"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#. **Календарный день** - Выбор календарного дня на который должен быть открыт календарь.
...
Элементы управления в представлении "Сводная таблица"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#. **Кол-во тахографов** - Одно из измерений, по которому выполняется суммирование значений. У различных объектов учета будет отличаться.
#. **Подсчет** - Выбор измерений, по которым выполняется суммирование количество значений. Общее для всех объектов учета.
#. **Поворот таблицы** - Замена местами столбцов и строк сводной таблицы.
#. **Развернуть все** - Раскрыть все выбранные характеристики.
#. **Скачать** - Сохранить сводную таблицу в файл формата MS Excel.
#. **Поиск** - Выполнение поисковых запросов по объектам учета (см. пункт :ref:`gui-search`).
#. **Таблица** - Табличная форма представления сведений об объектах учета  (см. пункт :ref:`gui-table`).
#. **Календарь** - Представление сведений об объекте учета в виде календаря (см. пункт :ref:`gui-calendar`).
...
Элементы управления в представлении "График"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#. **Расширенный поиск** - Включение / выключение режима расширенного поиска. При расширенном поиске в интерфейсе доступны элементы управления "Фильтры", "Группировать", "Избранное".
#. **Фильтры** - Создание новых, повторное применение или выбор предустановленных фильтров.
...
#. **Применить** - Применение заданного фильтра или комбинации фильтров.
#. **Добавить условие** - Добавление еще одно условия для фильтрации. При этом условия будут добавлено с операцией логическое "ИЛИ".
...
#. **Применить** - Применение заданной группировки.
...
#. **Название** - Название под которым должен быть сохранен текущий запрос на поиск.
...
#. **Совместно со всеми пользователями** - Установка признака доступности запроса другим пользователям. Если установить галочку, то данный запрос будет доступен другим пользователям в списке сохраненных запросов (см. 1.).
